  ...
  return (
    <div className="mb-8 lg:mb-12">
      <div className="space-y-4">
        ...
        <p className="text-zinc-400 text-base lg:text-lg max-w-1xl">A showcase of both private and open-source projects I’ve built or contributed to. Each project represents a unique challenge and learning experience.</p>
