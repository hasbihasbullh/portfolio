  ...
  return (
    <section className="px-4 sm:px-8 py-10 lg:py-20 max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
      <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[6rem] leading-none font-bold tracking-tighter">
          M HASBI HASBULLAH
        </h1>

        <p className="text-lg sm:text-xl lg:text-2xl text-zinc-400 max-w-full lg:max-w-none mx-auto lg:mx-0">
          A passionate developer specializing in modern web development with a focus on the latest technologies.
        </p>

        <Button
          className="relative overflow-hidden text-lg px-6 py-3"
          size="lg"
          variant="outline"
        ...
        <div className="flex justify-center lg:justify-normal gap-4 mt-4">
          <a
            ...
            className="bg-zinc-200 text-zinc-950 hover:bg-zinc-400 rounded-full p-3 transition-all duration-300"
          >
      ...
      <div className="relative mt-8 lg:mt-0">
        <Image
          src="/me.webp"
          alt="Foto Profil M Hasbi Hasbullah"
          width={400}
          height={500}
          className="w-full sm:w-[400px] h-[300px] sm:h-[500px] object-cover mx-auto rounded-lg shadow-lg"
          priority
        />
