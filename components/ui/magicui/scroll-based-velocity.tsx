...
export function VelocityScroll({ defaultVelocity = 5, numRows = 1, children, className, ...props }: VelocityScrollProps) {
  return (
    <div className={cn("relative w-full text-6xl font-bold tracking-[-0.01em] md:text-8xl md:leading-[5rem]", className)} {...props}>
